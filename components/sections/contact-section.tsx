...
export function ContactSection() {
  ...
  return (
    ...
    >
      {/* Éléments décoratifs */}
      <div className="decoration-element absolute top-0 right-0 w-64 h-64 rounded-full bg-violet-500/10 blur-3xl"></div>
      <div className="decoration-element absolute bottom-0 left-0 w-64 h-64 rounded-full bg-indigo-500/10 blur-3xl"></div>
      <div className="decoration-element absolute top-1/3 left-1/4 w-16 h-16 rounded-full bg-violet-500/20 blur-xl"></div>
      {/* <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-r from-violet-500/5 via-indigo-500/5 to-violet-500/5"></div> */}
      {/* <div className="absolute bottom-0 right-0 w-full h-20 bg-gradient-to-r from-indigo-500/5 via-violet-500/5 to-indigo-500/5"></div> */}
      ...
      <div className="section-content max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-violet-500 to-indigo-500 mx-auto mb-8"></div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center mb-16">
          <div className="contact-info-item flex items-center gap-3 text-white/80 hover:text-violet-300 transition-colors group">
            <div className="p-3 rounded-full bg-white/5 group-hover:bg-white/10 transition-colors">
              <Mail className="text-violet-400" size={20} />
            </div>
            <a href="mailto:ouattaraisaacpro@gmail.com" className="hover:underline">
        ...
        <div className="flex justify-center">
          <Button
            className="contact-button bg-gradient-to-r from-violet-500 to-indigo-500 hover:from-violet-400 hover:to-indigo-400 text-white border-none rounded-full px-8 py-6 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/20 hover:-translate-y-1 group"
            size="lg"
            asChild
          >
            <a
